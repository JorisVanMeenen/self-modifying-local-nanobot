...
class DreamConfig(Base):
    ...
    )  # Optional Dream-specific model override. Preset names are the recommended
    # value; when a preset name is given only the preset's *model* field is used
    # while Dream keeps sharing the main loop's provider (including FallbackProvider).
    # Raw model identifiers still work for backward compatibility but are deprecated
